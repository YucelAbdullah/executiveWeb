...
namespace MigrationNpgsqlServer.Migrations
{
    [DbContext(typeof(AppDbContext))]
    [Migration("20221123200121_First")]
    partial class First
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("executiveData.Address", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("executiveData.ApplicationRole", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("executiveData.ApplicationUser", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("executiveData.ApplicationUserImage", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("executiveData.City", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("executiveData.Customer", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("executiveData.Project", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("executiveData.ProjectImage", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("executiveData.Province", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("ApplicationUserProject", b =>
                {
                    b.HasOne("executiveData.ApplicationUser", null)
                        .WithMany()
                        .HasForeignKey("ApplicationUsersId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("executiveData.Project", null)
                        .WithMany()
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityRoleClaim<System.Guid>", b =>
                {
                    b.HasOne("executiveData.ApplicationRole", null)
                        .WithMany()
            ...
            modelBuilder.Entity("executiveData.Address", b =>
                {
                    b.HasOne("executiveData.City", "City")
                        .WithMany("Addresses")
            ...
            modelBuilder.Entity("executiveData.ApplicationUserImage", b =>
                {
                    b.HasOne("executiveData.ApplicationUser", "ApplicationUser")
                        .WithMany("ApplicationUserImages")
            ...
            modelBuilder.Entity("executiveData.City", b =>
                {
                    b.HasOne("executiveData.Province", "Province")
                        .WithMany("Cities")
            ...
            modelBuilder.Entity("executiveData.Project", b =>
                {
                    b.HasOne("executiveData.Address", "Address")
                        .WithMany("Projects")
                        .HasForeignKey("AddressId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("executiveData.Customer", "Customer")
                        .WithMany("Projects")
            ...
            modelBuilder.Entity("executiveData.ProjectImage", b =>
                {
                    b.HasOne("executiveData.Project", "Project")
            ...
            modelBuilder.Entity("executiveData.ApplicationUser", b =>
                {
                    b.Navigation("ApplicationUserImages");
                });
